...
def authenticate_with_login(user):
    ...
    if login_text.get('authenticated') and login.status_code == 200:
        ...
        print('STATUS: '+str(login.status_code))
    return data_json

data_json = authenticate_with_login('korepanov_nv')

photos = []
for edge in data_json['entry_data']['ProfilePage'][0]['graphql']['user']['edge_owner_to_timeline_media']['edges']:
    data = {
